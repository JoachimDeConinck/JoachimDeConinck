(function getDayAfterTomorrow() {
    let target = document.querySelector('.countdown[data-due-date]');
    let now = new Date();
    let formattedDate = $.datepicker.formatDate('yy/mm/dd', new Date(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate() + 2));
    target.setAttribute('data-due-date', formattedDate);
})();
